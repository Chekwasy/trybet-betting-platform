...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addDelayedJob",0,tM],93852);let tC={name:"addJobScheduler",content:`--[[
...
return {jobId .. "", delay}
`,keys:11};e.s(["addJobScheduler",0,tC],27599);let tP={name:"addLog",content:`--[[
  Add job log
  Input:
    KEYS[1] job id key
    KEYS[2] job logs key
...
`,keys:2};e.s(["addLog",0,tP],92879);let tN={name:"addParentJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addParentJob",0,tN],19348);let tJ={name:"addPrioritizedJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["addPrioritizedJob",0,tJ],55494);let tL={name:"addRepeatableJob",content:`--[[
...
`,keys:2};e.s(["addRepeatableJob",0,tL],30960);let t_={name:"addStandardJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["addStandardJob",0,t_],1939);let tV={name:"changeDelay",content:`--[[
...
if rcall("EXISTS", ARGV[4]) == 1 then
  ...
  return -1
end`,keys:4};e.s(["changeDelay",0,tV],24195);let tq={name:"changePriority",content:`--[[
  Change job priority
  Input:
    KEYS[1] 'wait',
    KEYS[2] 'paused'
...
`,keys:7};e.s(["changePriority",0,tq],21057);let tG={name:"cleanJobsInSet",content:`--[[
...
return result[1]
`,keys:3};e.s(["cleanJobsInSet",0,tG],41381);let tF={name:"drain",content:`--[[
...
`,keys:5};e.s(["drain",0,tF],46888);let tY={name:"extendLock",content:`--[[
...
return 0
`,keys:2};e.s(["extendLock",0,tY],56111);let tB={name:"extendLocks",content:`--[[
...
return failedJobs
`,keys:1};e.s(["extendLocks",0,tB],46003);let tz={name:"getCounts",content:`--[[
...
return results
`,keys:1};e.s(["getCounts",0,tz],19884);let tW={name:"getCountsPerPriority",content:`--[[
  Get counts per provided states
    Input:
      KEYS[1] wait key
      KEYS[2] paused key
...
return results
`,keys:4};e.s(["getCountsPerPriority",0,tW],65535);let tU={name:"getDependencyCounts",content:`--[[
...
return results
`,keys:4};e.s(["getDependencyCounts",0,tU],64623);let t$={name:"getJobScheduler",content:`--[[
...
return {nil, nil}
`,keys:1};e.s(["getJobScheduler",0,t$],33429);let tH={name:"getMetrics",content:`--[[
  Get metrics
  Input:
    KEYS[1] 'metrics' key
...
`,keys:2};e.s(["getMetrics",0,tH],36069);let tQ={name:"getRanges",content:`--[[
...
return results
`,keys:1};e.s(["getRanges",0,tQ],40615);let tZ={name:"getRateLimitTtl",content:`--[[
  Get rate limit ttl
    Input:
      KEYS[1] 'limiter'
      KEYS[2] 'meta'
...
`,keys:2};e.s(["getRateLimitTtl",0,tZ],95884);let tX={name:"getState",content:`--[[
  Get a job state
  Input: 
...
return "unknown"
`,keys:8};e.s(["getState",0,tX],61570);let t0={name:"getStateV2",content:`--[[
  Get a job state
  Input: 
    KEYS[1] 'completed' key,
    KEYS[2] 'failed' key
...
return "unknown"
`,keys:8};e.s(["getStateV2",0,t0],6789);let t1={name:"isFinished",content:`--[[
...
return 0
`,keys:3};e.s(["isFinished",0,t1],71707);let t2={name:"isJobInList",content:`--[[
...
`,keys:1};e.s(["isJobInList",0,t2],68134);let t3={name:"isMaxed",content:`--[[
...
`,keys:2};e.s(["isMaxed",0,t3],79499);let t4={name:"moveJobFromActiveToWait",content:`--[[
...
`,keys:9};e.s(["moveJobFromActiveToWait",0,t4],91017);let t6={name:"moveJobsToWait",content:`--[[
...
return 0
`,keys:8};e.s(["moveJobsToWait",0,t6],73652);let t5={name:"moveStalledJobsToWait",content:`--[[
...
return stalled
`,keys:8};e.s(["moveStalledJobsToWait",0,t5],26867);let t8={name:"moveToActive",content:`--[[
...
return {0, 0, 0, 0}
`,keys:11};e.s(["moveToActive",0,t8],10393);let t7={name:"moveToDelayed",content:`--[[
...
`,keys:8};e.s(["moveToDelayed",0,t7],85353);let t9={name:"moveToFinished",content:`--[[
...
`,keys:14};e.s(["moveToFinished",0,t9],28646);let re={name:"moveToWaitingChildren",content:`--[[
...
return -1
`,keys:7};e.s(["moveToWaitingChildren",0,re],82792);let rt={name:"obliterate",content:`--[[
...
`,keys:2};e.s(["obliterate",0,rt],35933);let rr={name:"paginate",content:`--[[
...
`,keys:1};e.s(["paginate",0,rr],50518);let rn={name:"pause",content:`--[[
...
`,keys:7};e.s(["pause",0,rn],77380);let ra={name:"promote",content:`--[[
...
`,keys:9};e.s(["promote",0,ra],30498);let ri={name:"releaseLock",content:`--[[
  Release lock
    Input:
      KEYS[1] 'lock',
      ARGV[1]  token
...
`,keys:1};e.s(["releaseLock",0,ri],47776);let rs={name:"removeChildDependency",content:`--[[
...
if removeParentDependencyKey(jobKey, false, parentKey, KEYS[1], nil) then
  ...
  return 1
end`,keys:1};e.s(["removeChildDependency",0,rs],90342);let ro={name:"removeDeduplicationKey",content:`--[[
...
return 0
`,keys:1};e.s(["removeDeduplicationKey",0,ro],91933);let rl={name:"removeJob",content:`--[[
...
return 0
`,keys:2};e.s(["removeJob",0,rl],25665);let rd={name:"removeJobScheduler",content:`--[[
...
return 1
`,keys:3};e.s(["removeJobScheduler",0,rd],73024);let ru={name:"removeRepeatable",content:`--[[
...
return 1
`,keys:3};e.s(["removeRepeatable",0,ru],66357);let rc={name:"removeUnprocessedChildren",content:`--[[
    Remove a job from all the statuses it may be in as well as all its data.
    In order to be able to remove a job, it cannot be active.
    Input:
      KEYS[1] jobKey
...
removeJobChildren(prefix, jobKey, options) 
`,keys:2};e.s(["removeUnprocessedChildren",0,rc],72997);let rp={name:"reprocessJob",content:`--[[
...
`,keys:8};e.s(["reprocessJob",0,rp],87721);let rh={name:"retryJob",content:`--[[
...
`,keys:11};e.s(["retryJob",0,rh],32559);let ry={name:"saveStacktrace",content:`--[[
...
`,keys:1};e.s(["saveStacktrace",0,ry],20332);let rm={name:"updateData",content:`--[[
  Update job data
  Input:
    KEYS[1] Job id key
    ARGV[1] data
...
`,keys:1};e.s(["updateData",0,rm],47479);let rf={name:"updateJobScheduler",content:`--[[
...
`,keys:12};e.s(["updateJobScheduler",0,rf],74677);let rb={name:"updateProgress",content:`--[[
  Update job progress
  Input:
    KEYS[1] Job id key
...
`,keys:3};e.s(["updateProgress",0,rb],70855);let rg={name:"updateRepeatableJobMillis",content:`--[[
  Adds a repeatable job
    Input:
      KEYS[1] 'repeat' key
      ARGV[1] next milliseconds
